...
cbind(overall_sp,list_gst[c(1,3,2),],list_rst[c(1,3,2),]) %>% 
    flextable(.,col_keys = c("sp","Hs","Ht","Fst","Gst","ci.Gst","Rst","ci.Rst")) %>% 
    add_footer_row(.,values = c("Total",basicstat$overall[c("Hs","Ht","Fst")],overall_gst,overall_rst), colwidths = c(1,1,1,1,1,1,1,1))%>%
